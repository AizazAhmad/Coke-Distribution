               ...
               <div class="col-xl-12">
                  <section class="hk-sec-wrapper">
                     <div class="row mb-3">
                          ...
                          <div class="col">
                             <a href="list-empexpmaintype.php" class="btn btn-secondary btn-wth-icon btn-rounded icon-right btn-sm"><span class="btn-text">Add Main Type</span> <span class="icon-label"><span class="feather-icon"><i data-feather="arrow-right-circle"></i></span> </span>
                             </a>
                          </div>
                           
                          <div class="col">
                            <a class="btn btn-gradient-info float-right" href="add-empexpense.php">Add EmpExpense</a>
                          </div>                            
                      </div>
                     <div class="row">
                        <div class="col-sm">
