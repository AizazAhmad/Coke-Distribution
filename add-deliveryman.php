...
$Title = "Delivery Man";
$title = "deliveryman";
$Code = code($_SESSION['user_id'],'deliveryman');
$emprole = fetchBySess($_SESSION['user_id'],'emprole');
?>
<!DOCTYPE html>
<html lang="en">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <select class="form-control" name="RoleId">
                                                    <?php for ($i=0; $i < count($emprole); $i++) {
                                                         ?>
                                                    <option value="<?=$emprole[$i]->Id?>"><?=$emprole[$i]->Name?></option>                                        <?php } ?>            
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group row">
