...
$Title = "EmpExpense";
$title = "empexpense";
$employee = fetchBySessAttr("RoleId","1","deliveryman");
                                    ...
                                    <form id="myform">
                                        <div class="form-group row">
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <select class="form-control" id="employeeid" name="EmpId">
                                                    <?php for ($i=0; $i < count($employee); $i++) {
                                                         ?>
                                                    <option value="<?=$employee[$i]->Id?>"><?=$employee[$i]->Name?></option>                                        <?php } ?>            
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <select class="form-control" id="mainexptypeid" name="EmpExpMainTyepId">
   ...
   <!-- jQuery -->
    ...
    fetchmaintype();
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo $action_url; ?>fetch_empmainexptype.php",
