            ...
            <div class="container mt-xl-50 mt-sm-30 mt-15">
                ...
                <div class="row">
                    ...
                    <section class="hk-sec-wrapper">
                            ...
                            <h5 class="hk-sec-title">Add Route</h5>
                                ...
                                <div class="col-sm">
                                    <form id="myform">
                                        ...
                                        <div class="form-group row mb-0">
                                            <div class="col-sm-6">
                                                <button type="submit" id="submit" class="btn btn-gradient-info">Add Route</button> 
                                            </div>
    ...
    transitionOut: 'flipOutX'
      ...
      $("#myform").submit(function (e) {
        ...
        $.ajax({
          ...
          complete: function() {
                $('#submit').empty().addClass('btn btn-gradient-info').html('Add Route');
