...
// $cooler = fetchBySessAttr('Is_Booked',0,'cooler');
...
<body>
            ...
            <div class="container mt-xl-50 mt-sm-30 mt-15">
                ...
                <div class="row">
                    ...
                    <section class="hk-sec-wrapper">
                            ...
                            <h5 class="hk-sec-title">Route Customer</h5>
   ...
   <!-- jQuery -->
    ...
    $.ajax({
          dataType : "json",   
          url : "<?php echo $action_url; ?>fetch_customers.php",          
          success: function (response) {            
            ...
            var customerlist = '';
                ...
                $("#customerjson").html(customerlist);    
          }
        });
    }
