            ...
            <div class="container mt-xl-50 mt-sm-30 mt-15">
                ...
                <div class="row">
                    ...
                    <section class="hk-sec-wrapper">
                            ...
                            <h5 class="hk-sec-title">Add Stock(Unfilled)</h5>
                                ...
                                <div class="col-sm">
                                    <form id="myform">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" name="UFBottle" class="form-control" id="bottle" placeholder="Bottles">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputEmail3" class="col-sm-2 col-form-label">Shells</label>
                                            <div class="col-sm-10">
                                                <input type="number" name="UFShell" class="form-control" id="shell" placeholder="Shells">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputEmail3" class="col-sm-2 col-form-label">Pallets</label>
                                            <div class="col-sm-10">
                                                <input type="number" name="UFPallet" class="form-control" id="pallets" placeholder="Pallets">
                                            </div>
                                        </div>
