...
<head>
  ...
  <link rel="stylesheet" href="<?=$assets_url?>css/sweetalert.min.css">
</head>
            ...
            <div class="col-xl-3 col-md-6">
              <div class="card card-stats">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Total SuperAdmin</h5>
                      <span class="h2 font-weight-bold mb-0"><?=$SuperAdmin?></span>
                    </div>
                    <div class="col-auto">
