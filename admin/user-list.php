          ...
          <div class="card">
            ...
            <div class="table-responsive py-4">              
              <table class="table table-flush" id="datatable-buttons">
                ...
                <tbody>
<?php
$query = "SELECT users.*, roles.Title as Role FROM users INNER JOIN roles ON users.RoleId = roles.Id WHERE Status = 1;";
$result = $db->query($query);

while ($row = $result->fetch_object()) {
    
    
    $ban_button = ban_button($row->Id, $action_url.'ban_user.php');
    $edit_button = edit_button($row->Id, $base_url.'edit-user.php');
    ...
    ?>
                  <tr>
                    ...
                    <td><?=$row->Role?></td>
                    <td><?=$row->Mobile?></td>
                    <td><span class="text-danger"></i><?php echo $ban_button." ".$edit_button; ?> </span> </td>
                  </tr>
<?php } ?>
                </tbody>
              </table>
