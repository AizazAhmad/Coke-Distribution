<?php
	...
	session_start();
    $base_url = "https://bms.dev/booker/";
    $base_path = $_SERVER['DOCUMENT_ROOT']."/booker";
    ...
    $photo_url = $base_url.'assets/uploads/';
    $userphoto_url = $base_url.'assets/users/';
    ...
    if(!isset($_SESSION['is_booker_login']))
