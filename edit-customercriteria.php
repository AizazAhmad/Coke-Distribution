...
$row = fetchRecord($_POST['id'],'customercriteria');
$user = fetchRecord($row->CustomerId,'customer');
                                ...
                                <div class="col-sm">
                                    <form id="myform">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" value="<?=$row->HTHDiscount?>" name="HTHDiscount" class="form-control" id="hthdiscount" placeholder="HTHDiscount">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" value="<?=$row->HTHShare?>" name="HTHShare" class="form-control" id="hthshare" placeholder="HTHShare">
                                            </div>
                                        </div>                                    
                                        <div class="form-group row">
                                            <label for="inputEmail3" class="col-sm-2 col-form-label">RGB Scheme</label>
                                            <div class="col-sm-10">
                                                <input type="number" value="<?=$row->RGB?>" name="RGB" class="form-control" id="rgb" placeholder="RGB">
                                            </div>
                                        </div>
