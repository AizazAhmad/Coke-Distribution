                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <form id="myform">
                                        ...
                                        <input type="hidden" name="PreviousAmount" value="<?php echo $row->Amount; ?>">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" name="Amount" class="form-control" id="amount" placeholder="Amount" value="<?php echo $row->Amount; ?>">
                                            </div>
                                        </div>                                      
