                                ...
                                <div class="col-sm">
                                    <form id="myform">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" name="FShell" class="form-control" id="fshell" value="<?php echo $row->FShell; ?>" placeholder="Code">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputEmail3" class="col-sm-2 col-form-label">Bottles</label>
                                            <div class="col-sm-10">
                                                <input type="number"  name="FBottle" class="form-control" id="fbottle" value="<?php echo $row->FBottle; ?>" placeholder="name">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" name="FPallet" class="form-control" id="fpallets" value="<?php echo $row->FPallet; ?>" placeholder="Cost">
                                            </div>
                                        </div>
