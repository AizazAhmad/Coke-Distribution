...
$Title = "Ledger";
$title = "ledger";
$row = fetchRecord($_POST['id'],'ledger');
?>
                                ...
                                <div class="col-sm">
                                    <form id="myform">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" value="<?php echo $row->Address; ?>" name="Address" class="form-control" id="address" placeholder="Address">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputEmail3" class="col-sm-2 col-form-label">Mobile</label>
                                            <div class="col-sm-10">
                                                <input type="number" value="<?php echo $row->Mobile; ?>" name="Mobile" class="form-control" id="mobile" placeholder="Mobile">
                                            </div>
                                        </div>                                      
