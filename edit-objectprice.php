                                ...
                                <div class="col-sm">
                                    <form id="myform">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text"  name="Name" class="form-control" id="name" value="<?php echo $row->Name; ?>" placeholder="name" disabled>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" name="Price" class="form-control" id="price" value="<?php echo $row->Price; ?>" placeholder="Price">
                                            </div>
                                        </div>
