                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <form id="myform">
                                        ...
                                        <div class="form-group row">
                                            <label for="inputEmail3" class="col-sm-2 col-form-label">DocumentNo</label>
                                            <div class="col-sm-10">
                                                <input type="number" name="DocumentNo" class="form-control" id="documentno" value="<?php echo $row->DocumentNo; ?>" placeholder="DocumentNo">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputEmail3" class="col-sm-2 col-form-label">Stock</label>
                                            <div class="col-sm-10">
                                                <input type="number" name="Stock" class="form-control" id="stock" placeholder="Stock" value="<?php echo $row->Stock; ?>" disabled>
                                            </div>
                                        </div>                                      
