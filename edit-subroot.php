                                    ...
                                    <form id="myform">
                                       ...
                                       <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <select class="form-control" id="rootid" name="RootId">
                                                    <?php for ($i=0; $i < count($root); $i++) {
                                                         ?>
                                                    <option value="<?=$root[$i]->Id?>" <?php if ($root[$i]->Id == $row->RootId)
                                                        echo "selected";?>><?=$root[$i]->Name?></option>                                        <?php } ?>            
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" name="Cost" class="form-control" id="cost" value="<?php echo $row->Cost; ?>" placeholder="Cost">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mb-0">
                                            <div class="col-sm-10">
                                                <button type="submit" id="submit" class="btn btn-gradient-info"><i id='sub' class='spinner-grow spinner-grow-sm mr-1'></i>Update</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
