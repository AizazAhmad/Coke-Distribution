                                ...
                                <div class="col-sm">
                                    <form id="myform">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" name="UFShell" class="form-control" id="fshell" value="<?php echo $row->UFShell; ?>" placeholder="Code">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputEmail3" class="col-sm-2 col-form-label">Bottles</label>
                                            <div class="col-sm-10">
                                                <input type="number"  name="UFBottle" class="form-control" id="fbottle" value="<?php echo $row->UFBottle; ?>" placeholder="name">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" name="UFPallet" class="form-control" id="fpallets" value="<?php echo $row->UFPallet; ?>" placeholder="Cost">
                                            </div>
                                        </div>
