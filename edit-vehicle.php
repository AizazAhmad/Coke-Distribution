...
$Title = "Vehicle";
$title = "vehicle";
$row = fetchRecord($_POST['id'],'vehicle');
?>
                                ...
                                <div class="col-sm">
                                    <form id="myform">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" value="<?php echo $row->Number; ?>" name="Number" class="form-control" id="number" placeholder="Type" Disabled>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputEmail3" class="col-sm-2 col-form-label">Type</label>
                                            <div class="col-sm-10">
                                                <input type="text" value="<?php echo $row->Type; ?>" name="Type" class="form-control" id="type" placeholder="Type">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" value="<?php echo $row->Value; ?>" name="Value" class="form-control" id="value" placeholder="Value">
                                            </div>
                                        </div>                                     
