...
// $DeliveryMan = $DMan->Code." ".$DMan->Name;
  ...
  SUM(secondarysale.TPromo)/SUM(secondarysale.Qty) AS TPAVG
FROM secondarysale
  INNER JOIN customer
                    ...
                    <section class="hk-sec-wrapper html-content">
                          ...
                          <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm">
                                     <div class="container" >  
                <h4 align="center" class="display-4 mt-2">Final Promo Sheet ( By Delivery Man )</h3><br />  
