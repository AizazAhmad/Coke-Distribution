...
$rows = fetchRecord($VehicleId,'vehicle');
    $Vehicle = $rows->Type." ".$rows->Number;


$Query = "SELECT * FROM vehexpense WHERE VehicleId = $VehicleId AND VMTypeId = $VMTypeId AND Date BETWEEN '$Start 00:00:00' AND '$End 23:59:59' AND UserId = {$_SESSION['user_id']}";
...
function fetch_Product($VehicleId,$VMTypeId,$Start,$End,$Query)  {  
                    ...
                    <section class="hk-sec-wrapper html-content">
                          ...
                          <div class="row">
                            <div class="col border">
                              <h6 class="display-6">Vehicle</h6><span><?=$Vehicle?></span>
                            </div>
                            <div class="col border">
                            ...
                            <div class="row">
                                <div class="col-sm">
                                     <div class="container" >  
                <h4 align="center" class="display-4 mt-2">Vehicle Expense Report</h3><br />  
                <?php if ($IsDisplay) { ?>
                  <div class="row justify-content-center">
                    <div class="col-auto">
                     ...
                     <?php
                      ...
                      echo fetch_Product($VehicleId,$VMTypeId,$Start,$End,$Query);
