                  ...
                  <section class="hk-sec-wrapper">
                     <div class="col">
                         <div class="row mb-3">
                          ...
                          <div class="col">
                            <a class="btn btn-gradient-info float-right" href="add-accounts.php">Add <?=$Title?></a>                  
                          </div>                              
                      </div>  
                     <div class="row">
                        <div class="col-sm">
                          ...
                          while ($row = $result->fetch_object()) {
                              ...
                              $btn_book = book_button($row->Id);
                              $btn_deposit = deposit_button($row->Id);    
                              $btn_transfer = transfer_button($row->Id);    
                              $btn_adjustment = adjustment_button($row->Id);    
                              ?>
                                  <tr>
                                      <td><?php echo $row->Name; ?></td>
                                      <td><?php echo $row->Number; ?></td>
                                      <td><?php echo $row->Balance; ?></td>           
                                      <td><?php echo $btn_book." ".$btn_deposit." ".$btn_transfer." ".$btn_adjustment; ?></td>
