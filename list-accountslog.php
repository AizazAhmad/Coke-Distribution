                  ...
                  <section class="hk-sec-wrapper">
                     <div class="col">
                         <div class="row mb-3">
                          ...
                          <div class="col">
                            <a class="btn btn-gradient-info float-right" href="add-deposit.php?id=<?=$ID?>">Add Deposit</a>                  
                          </div>                              
                      </div>  
                     <div class="row">
                        <div class="col-sm">
                           <div class="table-wrap">
                              ...
                              <tbody>
                          <?php
                          $query = "SELECT *,DATE_FORMAT(accountslog.Date, '%m/%d/%Y %H:%i') AS DateTime FROM accountslog INNER JOIN accounts ON accountslog.AccountId = accounts.Id WHERE AccountId = $ID;";
