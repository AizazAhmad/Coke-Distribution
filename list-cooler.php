...
<html lang="en">
   ...
   <body>
            ...
            <div class="row">
               <div class="col-xl-12">
                  <section class="hk-sec-wrapper">
                     <div class="row mb-3">
                          <div class="col">
                            <h5 class="hk-sec-title">Edit <?=$Title?></h5>
                          </div>   
                           <div class="col">
                            
                          </div>                       
                          <div class="col">
                            <a class="btn btn-gradient-info float-right" href="list-coolerdistribution.php">Distribute</a>
                            <a class="btn btn-gradient-info float-right" href="view-list-cooler.php">Go Back</a>
      ...
      <script type="text/javascript">
         ...
         function del(mech_id,row_index) {
            iziToast.settings({
         timeout: 2500,
         resetOnHover: true,
         animateInside: true,
         ...
         transitionOut: 'flipOutX'
            ...
            $.ajax({
          type: "POST",
          url : "<?=$action_url?>delete_<?=$title?>.php",
          data: {id:mech_id},
          beforeSend: function() {
