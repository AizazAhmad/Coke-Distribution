...
.container {
   ...
   <body>
               ...
               <div class="col-xl-12">
                  <section class="hk-sec-wrapper">
                    <div class="row mb-3">
                          ...
                          <div class="col">
                            <a class="btn btn-gradient-info float-right" href="view-list-customer.php">Go Back</a>
                          </div>                          
                      </div>
      ...
      <script type="text/javascript">
         ...
         function profile(mech_id,row_index){
            var form = document.createElement("form");
            form.method = 'post';
            form.action = '<?=$base_url?>customer-profile.php';
            var input = document.createElement('input');
            input.type = "hidden";
            input.name = "id";
            input.value = mech_id;
...
//     var count = 0;
//  $("#datable_1 thead th").each( function ( i ) {
