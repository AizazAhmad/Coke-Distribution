   ...
   <body>
            ...
            <div class="row">
               <div class="col-xl-12">
                  <section class="hk-sec-wrapper">
                     <div class="row mb-3">
                          <div class="col">
                            <h5 class="hk-sec-title">Edit Employee</h5>
                          </div>
                          <div class="col">

                          </div>
                          <div class="col">
                            <a class="btn btn-gradient-info float-right" href="view-list-deliveryman.php">Go Back</a>
                          </div>                             
                      </div>
                     <div class="row">
                        <div class="col-sm">
      ...
      <script type="text/javascript">
         ...
         function profile(mech_id,row_index){
            var form = document.createElement("form");
            form.method = 'post';
            form.action = '<?=$base_url?>profile.php';
            var input = document.createElement('input');
            input.type = "hidden";
            input.name = "id";
            input.value = mech_id;
