...
$title = "pendingprimaryemptyreturn";
?>
<!DOCTYPE html>
<html lang="en">
   <head>
            ...
            <div class="row">
               <div class="col-xl-12">
                  <section class="hk-sec-wrapper">
                     ...
                     <div class="row mb-3">
                          <div class="col">
                            <h5 class="hk-sec-title">Pending Empty List</h5>
                          </div>
                          <div class="col">
                          ...
                          <div class="col">
                            ...
                            <a class="btn btn-gradient-info float-right" href="list-primary-empty-return.php">Go Back</a>
                          </div>                             
                      </div>
                     <div class="row">
                        <div class="col-sm">
