...
$Title = "Primary Empty Return";
$title = "primaryemptyreturn";
?>
<!DOCTYPE html>
<html lang="en">
   <head>
               ...
               <div class="col-xl-12">
                  <section class="hk-sec-wrapper">
                     ...
                     <div class="row mb-3">
                          ...
                          <div class="col">
                           <a class="btn btn-gradient-info" href="list-pending-primary-empty-return.php">Pending Empty Return Log</a>
                            
                          </div>
                          <div class="col">
                            <a class="btn btn-gradient-info float-right" href="add-empty-return.php">Add Empty Return</a>
                          </div>                             
                      </div>
                     <div class="row">
                        <div class="col-sm">
