   ...
   <body>
               ...
               <div class="col-xl-12">
                  <section class="hk-sec-wrapper">
                     ...
                     <div class="row mb-3">
                          ...
                          <div class="col">
                            <a class="btn btn-gradient-info float-right" href="view-list-product.php">Go Back</a>
                          </div>                              
                      </div> 
      ...
      <script type="text/javascript">
         ...
         function edit(mech_id,row_index){
            ...
            form.method = 'post';
            form.action = '<?=$base_url?>edit-product.php';
         ...
         transitionOut: 'flipOutX'
            ...
            $.ajax({
          type: "POST",
          url : "<?=$action_url?>ban_product.php",
          data: {id:mech_id},
          beforeSend: function() {
