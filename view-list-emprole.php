               ...
               <div class="col-xl-12">
                  <section class="hk-sec-wrapper">
                     <div class="row mb-3">
                          ...
                          <div class="col">
                            <a class="btn btn-gradient-info" href="list-emprole.php">Edit Role</a> 
                            <a class="btn btn-gradient-info float-right" href="add-emprole.php">Add Role</a>                  
                          </div>                             
                      </div>
                     <div class="row">
                        <div class="col-sm">
