               ...
               <div class="col-xl-12">
                  <section class="hk-sec-wrapper">
                     ...
                     <div class="row mb-3">
                          ...
                          <div class="col">
                            <a class="btn btn-gradient-info" href="list-outlettype.php">Edit Outlet Type</a> 
                            <a class="btn btn-gradient-info float-right" href="add-outlettype.php">Add Outlet Type</a>                  
                          </div>                              
                      </div>
                     <div class="row">
                        <div class="col-sm">
