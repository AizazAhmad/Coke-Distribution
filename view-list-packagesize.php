            ...
            <div class="row">
               <div class="col-xl-12">
                  <section class="hk-sec-wrapper">
                     <div class="row mb-3">
                          <div class="col">
                            <h5 class="hk-sec-title">Pallet Package Size List</h5>
                          </div>                          
                          <div class="col">

                          </div>
                          <div class="col">
                            <a class="btn btn-gradient-info" href="list-packagesize.php">Edit Package Size</a> 
                            <a class="btn btn-gradient-info float-right" href="add-packagesize.php">Add Package Size</a>                  
                          </div>                            
                      </div>
                     <div class="row">
                        <div class="col-sm">
