            ...
            <div class="row">
               <div class="col-xl-12">
                  <section class="hk-sec-wrapper">
                     <div class="row mb-3">
                          <div class="col">
                            <h5 class="hk-sec-title">Supply Party List</h5>
                          </div>
                          <div class="col">

                          </div>
                          <div class="col">
                            <a class="btn btn-gradient-info" href="list-party.php">Edit Supply Party</a> 
                            <a class="btn btn-gradient-info float-right" href="add-party.php">Add Supply Party</a>                  
                          </div>
