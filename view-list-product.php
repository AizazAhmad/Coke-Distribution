               ...
               <div class="col-xl-12">
                  <section class="hk-sec-wrapper">
                     ...
                     <div class="row mb-3">
                          ...
                          <div class="col">
                            <a class="btn btn-gradient-info" href="list-product.php">Edit Product</a> 
                            <a class="btn btn-gradient-info float-right" href="add-product.php">Add Product</a>                  
                          </div>                              
                      </div> 
