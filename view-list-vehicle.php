               ...
               <div class="col-xl-12">
                  <section class="hk-sec-wrapper">
                     <div class="row mb-3">
                          ...
                          <div class="col">
                            <a class="btn btn-gradient-info" href="list-vehicle.php">Edit Vehicle</a> 
                            <a class="btn btn-gradient-info float-right" href="add-vehicle.php">Add Vehicle</a>                  
                          </div>                              
                      </div>
                     <div class="row">
                        <div class="col-sm">
